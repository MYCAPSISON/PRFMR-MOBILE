...
const s = StyleSheet.create({
  ...
  headerSub: { fontSize: 14, lineHeight: 20, marginTop: 3, fontFamily: "Inter_400Regular" },
  headerChips: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 12 },
  headerChip: { flexDirection: "row", alignItems: "center", borderRadius: 999, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 6 },
  headerChipText: { color: "#fb923c", fontSize: 11, fontWeight: "700", fontFamily: "Inter_700Bold" },
  planBlockBtn: { flexDirection: "row", alignItems: "center", borderRadius: 9, borderWidth: 1.5, paddingHorizontal: 10, paddingVertical: 6, gap: 7 },
  planBlockText: { fontSize: 11, fontWeight: "700", fontFamily: "Inter_700Bold" },
