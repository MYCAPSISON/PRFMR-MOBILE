...
const s = StyleSheet.create({
  ...
  header:     { flexDirection: "row", alignItems: "center", justifyContent: "space-between",
                paddingHorizontal: 16, paddingVertical: 19, borderBottomWidth: 1 },
  pageTitle:  { fontSize: 24, fontWeight: "800" },
  pageSubtitle: { fontSize: 15, lineHeight: 22, marginTop: 3, fontFamily: "Inter_400Regular" },
  scrollPad:  { padding: 16, gap: 18 },
  card:       { borderRadius: 12, borderWidth: 1.5, padding: 24 },
  cardTitle:  { fontSize: 22, fontWeight: "800" },
  listDescription: { fontSize: 14, lineHeight: 21, marginTop: 7, fontFamily: "Inter_400Regular" },
