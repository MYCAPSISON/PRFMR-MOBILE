...
const s = StyleSheet.create({
  ...
  cardTitle: { fontSize: 28, lineHeight: 32, fontWeight: "800", fontFamily: "Inter_700Bold" },
  ...
  metricsGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", rowGap: 24 },
  ...
  profileName: { fontSize: 30, lineHeight: 36, fontWeight: "800", fontFamily: "Inter_700Bold" },
  ...
  sportEditor: { marginTop: 20, gap: 14 },
  editorLabel: {
    fontSize: 13,
    fontWeight: "700",
  ...
  sportPickIcon: { width: 18, height: 18, tintColor: "#fff", opacity: 0.9 },
  sportPickText: { flex: 1, fontSize: 13, fontWeight: "700", fontFamily: "Inter_700Bold" },
  previewBox: { borderRadius: 10, padding: 14 },
  editorActions: { gap: 10, marginTop: 2 },
  primaryAction: { minHeight: 46, borderRadius: 9, alignItems: "center", justifyContent: "center" },
  primaryActionText: { color: "#fff", fontSize: 16, fontWeight: "800", fontFamily: "Inter_700Bold" },
  ghostAction: {
    minHeight: 44,
    borderRadius: 9,
    borderWidth: 1.5,
  ...
  ghostActionText: { fontSize: 15, fontWeight: "700", fontFamily: "Inter_700Bold" },
  removeAction: {
    minHeight: 42,
    borderRadius: 9,
    borderWidth: 1.5,
  ...
  removeActionText: { color: "#ef4444", fontSize: 14, fontWeight: "700", fontFamily: "Inter_700Bold" },
